          ...
          <select onChange={(e) => setrole(e.target.value)}
            className={
              darkMode
                ...
                : " my-20 w-full appearance-none bg-white border border-gray-300 text-gray-700 py-2 px-3 pr-10 shadow-sm focus:outline-none focus:ring-2 focus:ring-transparent transition"
            }
          >
